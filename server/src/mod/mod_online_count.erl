...
handle_call({apply_call, Module, Method, Args}, _From, State) ->
	F = fun(ErrMsg)->
				?WARNING_MSG("mod_shop__apply_call error: Module=~p, Method=~p, Reason=~p",[Module, Method, ErrMsg])
		end,
...
handle_cast({apply_cast, Module, Method, Args}, State) ->
	F = fun(ErrMsg)->
		 ?WARNING_MSG("mod_shop__apply_cast error: Module=~p, Method=~p, Args =~p, Reason=~p",[Module, Method, Args, ErrMsg])
	end,
